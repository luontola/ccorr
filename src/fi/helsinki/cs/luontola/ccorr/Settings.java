...
/**
 * Stores the global settings used by CCorr. The settings are loaded when this
...
public class Settings implements Serializable {
    ...
    /**
     * An instance of this class. The settings that need to be saved between 
     * program sessions are stored in an object so that they could be easilly 
     * saved and loaded by using {@link ObjectSaver ObjectSaver}.
     */
    private static Settings settings = new Settings();
    
    /**
     * Location of the settings file. It is in the user's home directory
     * with the name <code>.ccorr.cfg</code>.
     */
    ...
    /**
     * Sets the default part length for <code>ChecksumFile</code>.
     * If the value is less than <code>ChecksumFile.MIN_PART_SIZE</code> or 
     * greater than <code>ChecksumFile.MAX_PART_SIZE</code>, the nearest 
     * allowed value will be used.
     */
    public static void setDefaultPartLength(int length) {
     ...
     */
    public static int getDefaultPartLength() {
    ...
    /**
     * Sets the size and location of the {@link fi.helsinki.cs.luontola.ccorr.gui.MainWindow 
     * MainWindow} for future sessions.
     */
    ...
    /**
     * Returns the saved size and location of the 
     * {@link fi.helsinki.cs.luontola.ccorr.gui.MainWindow MainWindow}.
     */
     ...
     *
     * @param   monitor     an unused <code>ProgressMonitor</code> for the next 
     *                      one who calls <code>getProgressMonitor</code>, 
    ...
    /**
     * Returns the <code>ProgressMonitor</code> that was set with 
     * <code>setProgressMonitor</code> after which a new one must be set.
     *
     * @return  the <code>ProgressMonitor</code> that was set, or null 
     *          if one has not been set since <code>getProgressMonitor</code>
